package jmri.jmrix.mrbus.configurexml;

import jmri.jmrix.mrbus.SerialTurnoutManager;
...
public class SerialTurnoutManagerXml extends jmri.managers.configurexml.AbstractTurnoutManagerConfigXML {
    ...
    public void setStoreElementClass(Element turnouts) {
        turnouts.setAttribute("class", "jmri.jmrix.mrbus.configurexml.SerialTurnoutManagerXml");
    }
