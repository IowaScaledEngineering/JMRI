...
import jmri.jmrix.mrbus.MRBusSystemConnectionMemo;
import jmri.jmrix.mrbus.SerialPortController;
import jmri.jmrix.mrbus.SerialSensorManager;
...
public class SerialDriverAdapter extends SerialPortController implements jmri.jmrix.SerialPortAdapter {
    ...
    public SerialDriverAdapter() {
        super(new MRBusSystemConnectionMemo());
        this.manufacturerName = jmri.jmrix.mrbus.SerialConnectionTypeList.MRBUS;
    }
    ...
    public void configure() {
        ...
        jmri.InstanceManager.setTurnoutManager(jmri.jmrix.mrbus.SerialTurnoutManager.instance());
        jmri.InstanceManager.setLightManager(jmri.jmrix.mrbus.SerialLightManager.instance());
    ...
    protected void setSerialPort() throws gnu.io.UnsupportedCommOperationException {
        ...
        int baud = 115200;  // default, but also defaulted in the initial value of selectedSpeed
    ...
    protected String[] validSpeeds = new String[]{"115.2k baud"};
