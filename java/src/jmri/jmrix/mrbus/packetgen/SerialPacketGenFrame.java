package jmri.jmrix.mrbus.packetgen;
 ...
 * @version	$Revision$
 */
public class SerialPacketGenFrame extends jmri.util.JmriJFrame implements jmri.jmrix.mrbus.SerialListener {
    ...
    public void initComponents() throws Exception {
        ...
        setTitle("Send MRBus serial command");
